          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="mb-8 text-[#6C6A61]">
                We are dedicated to providing you with the finest luxury experience. 
                Our team is always available to assist you with any inquiries.
              </p>

              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-medium mb-2 ">Location</h4>
                  <p className="text-[#6C6A61]">123 Luxury Avenue, Suite 500<br />Munich,  10001</p>
                </div>

                <div>
                  <h4 className="text-lg font-medium mb-2">Hours</h4>
                  <p className="text-[#6C6A61]">Monday - Friday: 9am - 7pm<br />Saturday: 10am - 6pm<br />Sunday: By appointment only</p>
                </div>

                <div>
                  <h4 className="text-lg font-medium mb-2 ">Contact</h4>
                  <p className="text-[#6C6A61]">Email: clientservices@dedsv.com<br />Phone: +49 (212) 555-0123</p>
                </div>
              </div>
            </div>
            ...
            <div className=" p-8 border border-[#45423D]">
              ...
              {submitStatus === 'success' ? (
                <div className=" p-4 border border-[#6C6A61]">
                  <p>Thank you for contacting the DEDSV store. Our team will be in touch shortly.</p>
                </div>
              ) : (
